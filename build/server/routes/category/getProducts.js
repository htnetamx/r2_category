...
exports.getProductsByCategoryIdRoute = void 0;
const category_1 = require("../../../controller/category");
class getProductsByCategoryIdRoute {
    constructor(server) {
        this.getProductsByCategoryId = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield new category_1.CategoryController().getProductsByCategoryId(req.params.id);
                console.log("Result");
                console.log(result);
    ...
    configureEndPoints(baseUrl) {
         ...
         */
        this.server.get(`${baseUrl}category/:id/product`, this.getProductsByCategoryId);
    }
}
exports.getProductsByCategoryIdRoute = getProductsByCategoryIdRoute;
